...
rsync -cva -e ssh --inplace --exclude=*pg_xlog* --exclude=postgresql.conf --exclude=pg_hba.conf --exclude=recovery.conf --exclude=postmaster.pid /var/lib/postgresql/9.1/main/ 192.168.1.20:/var/lib/postgresql/9.1/main/
